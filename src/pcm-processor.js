...
class WASMWorkletProcessor extends AudioWorkletProcessor {
    constructor(options) {
        ...
        rb = new RingBuffer(options.processorOptions.sab, Float32Array);
        super();
    }
    ...
    process(inputs, outputs, parameters) {
        ...
        rb.pop(l, RENDER_QUANTUM_FRAMES);
...
registerProcessor('pcm-worklet-processor', WASMWorkletProcessor);

/*
If ES6 imports worked, we could do: import { RingBuffer } from "./ringbuf.js";
But, Firefox gives "Error: Module resolve hook not set", so copy and paste the ringbuffer class below
*/
